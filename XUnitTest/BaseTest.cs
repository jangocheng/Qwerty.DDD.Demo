...
//            const string connectionString = @"server=.;database=tets;user id=root;password=123;persistsecurityinfo=True;AutoEnlist=false;";
            const string connectionString = @"Data Source = localhost; Initial Catalog = test; Integrated Security = False; Persist Security Info = False; User ID = sa; Password = 123456";
